...
return [
    ...
    */
    ...
    'users' => [
        ...
        'deleted_message' => '“:name” deleted. Nothing in the maintenance record named them, so their email address and employee number are free to use again.',
        'retired_message' => '“:name” removed and can no longer sign in. Their completed checklists and signatures are kept, so the account is retired rather than deleted — tick “Show removed” to find or restore it.',
        'restored_message' => '“:name” restored, and left switched off. Turn the account on when they are ready to sign in.',
        'show_deleted' => 'Show removed',
        'deleted_badge' => 'Removed',
        'restore' => 'Restore',
        'taken' => 'Already used by :name.',
        'taken_by_deleted' => 'Already used by :name, whose account was removed. Tick “Show removed” above to restore that account, or choose something else — a removed account keeps its details so old work stays attached to the right person.',
        'delete_keeps_record' => 'Remove “:name”? They can no longer sign in. Everything they completed or signed is kept and still shows their name — a maintenance record is never rewritten — so the account is retired rather than deleted, and you can restore it later.',
        'delete_removes' => 'Delete “:name”? Nothing in the maintenance record names them, so the account will be removed outright and their email address and employee number become free to use again. This cannot be undone.',
    ...
    */
    'mail' => [
        ...
        'transport_smtp' => 'SMTP relay (port 587)',
