...
<div
    ...
    <?php echo e($attributes->merge(['class' => "flex items-start gap-3 rounded-xl border p-4 text-base {$classes}"])); ?>

>
    <svg class="mt-0.5 h-6 w-6 shrink-0 <?php echo e($iconClass); ?>" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    <div class="min-w-0 flex-1"><?php echo e($slot); ?></div>
</div>
