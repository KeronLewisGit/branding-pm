...
<div <?php echo e($attributes->merge(['class' => 'flex flex-wrap items-center justify-between gap-4'])); ?>>
    <h1 class="text-2xl font-bold text-slate-900 [.kiosk_&]:text-white"><?php echo e($title); ?></h1>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($actions)): ?>
        <div class="flex flex-wrap items-center gap-3"><?php echo e($actions); ?></div>
